...
import landingimage from "../../assets/images/LandingImages/idea.svg";
const Landing = () => {
                ...
                <div className="w-full mt-3 mb-3 xl:text-lg lg:text-lg md:text-md sm:text-landingfont text-xs pl-1 2xl:pt-5 xl:pt-5 lg:pt-5">
                  <p className="flex flex-col xl:text-lg lg:text-lg md:text-sm sm:text-sm text-xs">
                    <span className="pb-2">
                      ...
                      Students Club - VIT.  Students develop their skills in this thriving environment and build solutions for organizations and the community.
